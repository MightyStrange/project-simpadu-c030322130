                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="section-header-button">
                                    <a href="<?php echo e(route('user.create')); ?>" class="btn btn-primary">New User</a>
                                </div>
                            </div>
                            <div class="card-body">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\prase\Downloads\project\project-simpadu\resources\views/pages/users/index.blade.php ENDPATH**/ ?>